    ...
    <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          >
            <span className="text-white">Describe Your App.</span>
            <br />
          ...
          >
            Transform your ideas into production-ready iOS and Android apps using
            natural language. RUX generates React Native + Expo code instantly.
          </motion.p>
          ...
          <motion.div
            ...
            className="mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-slate-500"
          >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  ...
                  <div className="glass rounded-xl p-4 font-mono text-xs">
                    <div className="space-y-1">
                      ...
                      <div className="text-slate-500">{"// Generated by RUX"}</div>
                      <div className="text-emerald-400">{"export function App() {"}</div>
                      <div className="text-slate-300 pl-4">{"return <View>...</View>"}</div>
