  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        <div className="flex-1 relative bg-background">
          {!currentProject ? (
            ...
            <>
              ...
              {/* Loading overlay */}
              {isLoading && (
                <div className="absolute inset-0 bg-background/90 flex flex-col items-center justify-center backdrop-blur-sm">
        ...
        {/* Info footer */}
        <div className="px-4 py-2 border-t border-white/10 bg-black/40 text-xs text-slate-500 flex items-center justify-between">
