...
export default function SignInPage() {
  ...
  useEffect(() => {
    async function fetchProviders() {
      try {
        // Try to detect enabled providers by checking Supabase configuration
        // This is a client-side approach - in production, you might want a server endpoint
        ...
        for (const providerName of providersToCheck) {
          if (PROVIDER_CONFIGS[providerName]) {
            // Add provider if config exists
            // In a real implementation, you would check if the provider is actually configured
            // For now, we'll add all configured providers
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-400">
              Sign in to your RUX account to continue
            </p>
          </div>
